...
class Edit_Ol(QDialog):
    def __init__(self, user, elements):
        ...
        self.label_time_2.setText(str(self.elements[3]))
        self.label_place_2.setText(str(self.elements[4]))
        self.label_duration_2.setText(str(self.elements[5]))
        self.label_date_result_2.setText(str(self.elements[6]))
...
class Edit_Res(QDialog):
    def __init__(self, user, elements):
        ...
        self.label_name_2.setText(str(self.elements[0]))
        self.label_date_res_2.setText(str(self.elements[1]))
        self.label_score_2.setText(str(self.elements[2]))
        self.label_res_2.setText(str(self.elements[3]))
